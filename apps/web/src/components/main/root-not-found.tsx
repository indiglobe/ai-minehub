      ...
      >
        <div className={cn(`flex flex-col gap-4`)}>
          <div className={cn(`flex items-center gap-2`)}>
            <span className={cn(`text-accent-500 text-sm font-medium`)}>
              404
            </span>
          ...
          <p className={cn(`text-accent-700 dark:text-accent-300 text-sm`)}>
            The page you're looking for doesn't exist or may have been moved.
          </p>

          <div className={cn(`flex w-full pt-2`)}>
            <Button variant={"secondary"} className={cn(`ml-auto`)}>
              <Link to="/" tabIndex={-1}>
                Go home
              </Link>
            </Button>
