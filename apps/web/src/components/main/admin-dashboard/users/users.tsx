...
import { useFetchAllusers } from "@/integrations/tanstack/react-querry/dashboard/admin-dashboard";
...
export function AllUsers({ className, ...props }: ComponentProps<"section">) {
  ...
  const { isLoading, isError, data: users } = useFetchAllusers();
                            ...
                            <td className={cn(`py-4 pr-4`)}>
                              <div className={cn(`flex items-center gap-3`)}>
                                ...
                                <div className={cn(`flex flex-col`)}>
                                  ...
                                  {!item.referrerId && <span>No referrer</span>}
                                </div>
                              </div>
                            </td>
                            <td
                            ...
                            <td className={cn(`py-4 text-right`)}>
                              ...
                              >
                                <Link
                                  ...
                                  className={cn(
                                    `flex size-7 items-center justify-center rounded-md bg-blue-600/20 text-blue-500 transition-colors hover:bg-blue-600/30`,
                                  )}
                                  title="View User"
                                >
                                ...
                                <button
                                  className={cn(
                                    `flex size-7 items-center justify-center rounded-md bg-green-500/20 text-green-500 transition-colors hover:bg-green-500/30`,
                                  )}
                                ...
                                <button
                                  className={cn(
                                    `flex size-7 items-center justify-center rounded-md bg-yellow-500/20 text-yellow-500 transition-colors hover:bg-yellow-500/30`,
                                  )}
                                  title="Manage User"
                                >
