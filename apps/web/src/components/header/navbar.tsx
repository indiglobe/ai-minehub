            ...
            <NavigationMenuItem key={text}>
              {children && children.length > 0 && (
                <>
                  <NavigationMenuTrigger className={cn(`px-0`)}>
                    <NavigationMenuLink asChild>
                      <Link
                        to={to}
                        className={cn(
                          `group/nav-item flex flex-row items-center gap-x-1 rounded-md px-4`,
                        )}
                        tabIndex={-1}
                      >
                        <span>{text}</span>
                  ...
                  <NavigationMenuContent className={cn(`min-w-max rounded-md`)}>
                    <ul
                        ...
                        return (
                          <li key={text}>
                            <Button
                              ...
                              variant={"ghost"}
                              className={cn(
                                `border-primary-500/30 bg-primary-500/5 hover:bg-primary-500/20 h-14 w-full items-start border px-2 text-left`,
                              )}
                            >
                              <Link
                                to={to}
